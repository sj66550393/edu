						...
						<div class="form-group">
							...
							<div class="col-sm-9">
                                                            <select class="combox form-control"  id = "knowstypeid" name="args[knowstypeid]">                                                 
                                                                    {x2;tree:$knowstype,knowstype1,kid}
							  		<option value="{x2;v:knowstype1['knowstypeid']}" {x2;if:$knows['knowstypeid'] == v:knowstype1['knowstypeid']}selected = "selected" {x2;endif}>{x2;v:knowstype1['knowstype']}</option>
							  		{x2;endtree}
						  		</select>							
                                                        </div>
						</div>       
