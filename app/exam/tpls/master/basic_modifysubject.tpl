							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input class="form-control" name="args[subject]" id="subject" type="text" size="30" value="{x2;$subject['subject']}" needle="needle" msg="您必须输入一个科目名称" />
                                                        ...
                                                        <div class="form-group">
								<label for="subject" class="control-label col-sm-2">所属年级：</label>
								<div class="col-sm-4">
                                                                <select name= args[gradeid] class="combox form-control">
							  		{x2;tree:$grade,grade1,gid}
							  		<option name="gradeid" value="{x2;v:grade1['gradeid']}" {x2;if:$subject['gradeid'] == v:grade1['gradeid']}selected = "selected" {x2;endif}>{x2;v:grade1['grade']}</option>
							  		{x2;endtree}
						  		</select>								
                                                                </div>
							</div>
