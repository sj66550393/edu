 ...
 $qid++; ?>
                            <li class="text_in">
                            	<!--<input type="checkbox" name="args[questype][<?php echo $quest; ?>]" value="1"/>--><?php echo $quest['questype']; ?>（共<?php echo $this->tpl_var['numbers'][$quest['questid']]; ?>题），选 <input id="question_<?php echo $quest['questid']; ?>" type="text" class="form-control" style="width:60px;" name="args[number][<?php echo $quest['questid']; ?>]" onChange="javascript:check_num(this);" onblur="" rel="<?php echo $this->tpl_var['numbers'][$quest['questid']]; ?>"/> 题
